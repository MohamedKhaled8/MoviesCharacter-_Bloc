...
import 'package:bloclearn/presentation/widgets/character_widgets/custom_characters_items.dart';
  ...
  void addSearchedFOrItemsToSearchedList(String searchedCharacter) {
    searchedForCharacters = allCharacters
        .where((character) =>
            ...
            character.name.toUpperCase().startsWith(searchedCharacter))
        .toList();
    setState(() {});
  }
    ...
    return BlocBuilder<CharactersCubit, CharactersState>(
      builder: (context, state) {
        if (state is CharactersLoaded) {
          allCharacters = (state).charactersModel;
